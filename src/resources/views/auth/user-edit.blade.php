                ...
                <div class="p-6 bg-white border-b border-gray-200">
                    <form method="POST" action="{{ route('user.updateProfile', $user->id) }}" enctype="multipart/form-data">
                        ...
                        <div class="mt-4">
                            ...
                            <select id="generation" name="generation" class="block mt-1 w-full border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm" required>
                        ...
                        <div class="mt-4">
                            ...
                            <x-text-input id="target" class="block mt-1 w-full" type="text" name="target" :value="$user->target" required />
                        ...
                        <div class="mt-4">
                            ...
                            <input id="icon_image" class="block mt-1 w-full" type="file" name="icon_image" accept="image/*" />
                            @if ($user->icon_image)
                                <div class="mt-2">
                                    <img src="{{ asset('storage/' . $user->icon_image) }}" alt="User Icon" class="w-20 h-20 rounded-full">
                                </div>
                            @endif
